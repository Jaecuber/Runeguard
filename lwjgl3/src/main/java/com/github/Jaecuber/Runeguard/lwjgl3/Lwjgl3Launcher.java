package com.github.Jaecuber.Runeguard.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("Runeguard");
        ...
        configuration.setWindowedMode((int)(Launcher.WORLD_WIDTH * 75f), (int)(Launcher.WORLD_HEIGHT * 75f));
        //// You can change these files; they are in lwjgl3/src/main/resources/ .
        //// They can also be loaded from the root of assets/ .
        configuration.setWindowIcon("runeguard128.png", "runeguard64.png", "runeguard32.png", "runeguard16.png");
